...
// @desc    Create or update user profile e
// @access  Private
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
  try {
    ...
    // Get index of the experience with a specific id
...
router.delete('/education/:edu_id', auth, async (req, res) => {
  try {
    ...
    // Get index of the education with a specific id
    ...
    // remove education at that index
